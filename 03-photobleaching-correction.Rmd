...
```{r bleached-unrelated-intensity-traces, fig.show='hold', out.width='45%', echo=FALSE, fig.height=2.5, fig.width=3, fig.cap='(ref:unrelated-intensity-traces-caption)'}
set.seed(1)
