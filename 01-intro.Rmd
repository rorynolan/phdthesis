...
1. In FCS, it's very common for people to mistake correlation for cross-correlation. This is unfortunate but knowing about this common mistake is essential for navigating the field in a sensible manner. It seems that when people in the field correlate the signals from two separate channels, the use the term _cross-_correlation, even though they're only using correlation. I think the idea of working _across_ two or more channels (and ideas such as _cross_-talk) leads to this confustion.
