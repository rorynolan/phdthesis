...
\addcontentsline{toc}{subsubsection}{In preparation}
...
Symbol & Meaning\\
\hline
\$\textbackslash{}theta\$ & angle of incident light ray\\
\hline
...
\$G\$ & autocorrelation\\
\hline
\$\textbackslash{}varphi\$ & concentration\\
\hline
\$\textbackslash{}text\{corr\}\$ & correlation\\
\hline
\$\textbackslash{}theta\_c\$ & critical angle\\
\hline
\$\textbackslash{}text\{crosscor\}\$ & cross-correlation\\
\hline
\$B\_\textbackslash{}text\{cc\}\$ & cross-corrlated brightness\\
\hline
\$\textbackslash{}sigma\textasciicircum{}2\_\textbackslash{}text\{cc\}\$ & cross-variance\\
\hline
\$\textbackslash{}tilde\{x\}\$ & deviation of \$x\$ from the mean \$\textbackslash{}mu\$ of \$X\$\\
\hline
\$D\$ & diffusion constant\\
\hline
\$J\$ & diffusive flux\\
\hline
\$\textbackslash{}epsilon\$ & entity brightness\\
\hline
\$E\$ & expectation operator\\
\hline
\$\textbackslash{}tau\$ & exponential smoothing parameter\\
\hline
\$j\$ & frame number\\
\hline
\$S\_0\$ & highest occupied molecular orbital\\
\hline
\$I\$ & intensity\\
\hline
\$l\$ & length parameter of boxcar\\
\hline
\$T\_1\$ & lowest energy triplet state\\
\hline
\$S\_1\$ & lowest unoccupied molecular orbital\\
\hline
\$\textbackslash{}mu\$ & mean\\
\hline
\$\textbackslash{}text\{msd\}\$ & mean squared displacement\\
\hline
\$n\$ & moment number; number of entities; number of replicates\\
\hline
\$\textbackslash{}mathbb\{N\}\_0\$ & natural numbers (including zero)\\
\hline
\$d\$ & number of dimenions\\
\hline
\$\textbackslash{}alpha\$ & number of swaps\\
\hline
...
\$X\$ & random variable\\
\hline
\$\textbackslash{}mathbb\{R\}\$ & real numbers\\
\hline
\$n\_2\$ & refractive index of cover slip\\
\hline
\$n\_1\$ & refractive index of sample on cover slip\\
\hline
\$\textbackslash{}tau\_D\$ & residence time of particle (in confocal volume)\\
\hline
\$i\$ & slice number\\
\hline
\$\textbackslash{}text\{exp\}\$ & the exponential function\\
\hline
\$t\$ & time\\
\hline
\$\textbackslash{}text\{Var\}\$ & variance function\\
\hline
\$\textbackslash{}sigma\textasciicircum{}2\$ & variance in intensity\\
\hline
\$y\$ & vertical position\\
\hline
\end{tabular}
...
These two electronic states (S\textsubscript{0} and S\textsubscript{1})
of a molecule are defined as the highest occupied molecular orbital
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/Jablonski} \hfill{}
...
\includegraphics[width=0.7\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/quora_confocal} \hfill{}
...
measured \citep{HammamatsuPMT}. See figure \ref{fig:PMT}. This current
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/PMT} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/APD} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/HyD} \hfill{}
...
to be in units of photons unless otherwise stated.
...
the setup: the optics are less complex and there is no need to scan
across the sample to acquire each pixel (which requires precise
robotics). Another advantage is that images can be acquired faster
because all pixels in a frame are acquired simultaneously. The
disadvantage of this is that the absence of confocal optics means that
out of focus light can make it to the detection device (camera).
...
\includegraphics[width=0.5\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/Widefield} \hfill{}

\caption{Light travels from the uniformly illuminated
sample through a lens (or a few lenses) to the camera. Note the
...
is that it is not applicable when one cannot have the object of interest
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/TIRFig} \hfill{}

\caption{The thin evanescent wave close to the boundary
(between the cover slip and sample) where TIR is occurring. Only the
part of the sample within this thin evanescent wave is illuminated.
\(n_1\) is the refractive index of the sample and \(n_2\) is the
refractive index of the cover slip; \(n_1<n_2\) is assumed. \(\theta_c\)
is the critical angle and \(\theta\) is the incident angle of the laser
light; \(\theta > \theta_c\) is assumed.}\label{fig:TIRFig}
\end{figure}
...
CCD imaging substrate. These relatively new cameras offer 95\% quantum
efficiency \citep{photometrics}, very low noise, rapid frame rates,
large dynamic range, high resolution and wide field of view, all cheaper
than a regular CCD \citep{sCMOS}.
...
\includegraphics[width=0.5\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/confocal_volume_particle} \includegraphics[width=0.5\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/cvp} \hfill{}

\caption{Left: a fluorophore diffusing
through the confocal volume \citep{sphd}. Right: the intensity trace due
to this fluorophore.}\label{fig:confocal-volume-particle}
\end{figure}
...
approach (section \ref{PCF}) can be used to image barriers to diffusion
\citep{PCF}; diffusion barriers necessarily lead to anomalous diffusion.
...
frame. That is the length of time from the start of detection of photons
from the first pixel to the end of detection of photons from the last
pixel.
\EndKnitrBlock{definition}
...
332 downloads per month which amounts to 2,563 since it was first
released.
...
users. It gets 628 downloads per month which amounts to 10,995 since it
was first released.
...
of use. It gets 358 downloads per month which amounts to 3,421 since it
was first released.
...
\citep{filesstrings}. It gets 799 downloads per month which amounts to
14,017 since it was first released.
...
2017.\citep{exampletestr} It gets 507 downloads per month which amounts
to 8,509 since it was first released.
...
\includegraphics[width=0.48\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/rh} \includegraphics[width=0.48\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/rh_lego_plot} \hfill{}
...
the effect of redistributing mean intensity but \emph{also} variance in
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/detrend_compare} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/foldchanges} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/nandb-fig} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/bleachvis1} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/jove-dimerization} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/HIVStoichiometrySetup} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/HIVStoichiometryIntensity} \hfill{}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/HIVStoichiometryAnalysis} \hfill{}
...
\includegraphics[width=0.47\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/X4plot} \includegraphics[width=0.47\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/R5plot} \hfill{}
...
undergoes gp120 disassembly leading to 6 helix bundle formation. For R5
tropic virions, Env -- CD4 interactions form the previously described
...
4±0.3 CD4, 2±0.3 CCR5 and 1 JR-FL Env.
\end{quote}
...
\includegraphics[width=1\linewidth]{/Users/rnolan/Dropbox/DPhil/phdthesis/img/HIVStoichiometryStructure} \hfill{}

\caption{Pre-fusion reaction sequences
for the R5 (a) and X4 (B) tropic cases.}\label{fig:HIVStoichiometryStructure}
\end{figure}
