...
the following reliable rules of thumb:
...
\item
  ...
  authors. The NSMB paper \citep{HIVstoichiometry} was written by Maro
  and Sergi; I also made significant contributions to the writing of
  that manuscript but my main role in that project was in data analysis.
  In all other papers where I am listed as an author, my role was minor.
\end{itemize}
...
according to poisson statistics.\footnote{\url{https://en.wikipedia.org/wiki/Poisson_distribution}}
...
\tightlist
\item
  interaction implies that A and B are \emph{stuck} together
\item
...
363 downloads per month which amounts to 2268 since it was first
released.
...
users. It gets 561 downloads per month which amounts to 8994 since it
was first released.
...
of use. It gets 396 downloads per month which amounts to 3198 since it
was first released.
...
756 downloads per month which amounts to 12139 since it was first
released.
...
2017.\citep{exampletestr} It gets 457 downloads per month which amounts
to 6994 since it was first released.
...
moment). \texttt{img1} has a median mean pixel intensity of 98 and a
...
cells with mClover-labelled FKBP12. We found a brightness increase in
...
would bring our figure of 1.6 a lot closer to 2. We also tried the naive
choice of \(\tau=10\), which gave a decrease in brightness, showing that
arbitrary parameter choices lead to unpredictable and unreliable results
