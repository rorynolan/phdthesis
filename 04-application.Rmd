...
For the X4 and R5-tropic cases, structural modelling of the hypothesis has been done. See figure \@ref(fig:HIVStoichiometryStructure). 

(ref:HIVStoichiometryStructure-caption) Pre-fusion reaction sequences for the R5 (a) and X4 (B) tropic cases.
