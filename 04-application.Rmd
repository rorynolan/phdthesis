...
We found a brightness increase in $\epsilon$ of $\approx 1.6$-fold using the _automatic_ detrending method. Assuming thae population was all monomers before ligand addition, the $\approx 1.6$-fold increase upon addition suggests that dimerization had occurred (see figure \@ref(fig:FKBPfoldchanges)), however, we expected the increase to be $\approx 2$-fold upon dimerization. There could be many reasons for this discrepancy. 

1. FKBP is natively expressed in Cos7 cells, so depending on the level of native expression (not labelled) and the level of expression of our transfected FKBP (labelled), it could be that many cases of what is actually a dimer is behaving like a monomer because only one of the pair is labelled.
